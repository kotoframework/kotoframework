...
//
//        assertEquals(
//            "remove from tb_user where id = :id", sql
//        )
//    }
//
//    @Test
...
//        )
//        assertEquals(
//            "remove from tb_user where id in (:ids)", sql
//        )
//    }
//
//    @Test
...
//        )
//        assertEquals(
//            "remove from tb_user where ${deleted()} and `user_name` = :userName and `sex` = :sex and `city` = :city",
//            sql
//        )
//    }
//
...
//        )
//        assertEquals(
//            "remove from tb_user where ${deleted()} and birthday is null and password is null and sex is null and nickname is null and telephone is null and avatar is null and id is null and `user_name` = :userName and age is null and email is null",
//            prepared.sql
//        )
//    }
//
...
//        )
//        assertEquals(
//            "remove from tb_user where ${deleted()} and `user_name` = :userName",
//            prepared.sql.trim()
//        )
//    }
//}
