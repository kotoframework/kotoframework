...
abstract class KotoJdbcWrapper {
    abstract fun forList(sql: String, paramMap: Map<String, Any?>): List<Map<String, Any>>
    abstract fun <T> forObject(sql: String, paramMap: Map<String, Any?>, clazz: Class<T>): T?
